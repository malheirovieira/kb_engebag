...
class ArtigoAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        # Se o artigo é novo (não tem chave primária ainda)
        if not obj.pk:
            # Pega o nome atual do usuário selecionado no campo 'autor'
            # Se o autor selecionado tiver nome completo, usa ele, senão usa o username
